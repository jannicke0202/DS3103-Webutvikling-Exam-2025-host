...
const AvailableAthletes = () => {
  ...
  const available = athletes.filter(a => a.purchaseStatus === false);
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
      {available.map((athlete) => (
        ...
        >
          {/* Placeholder image */}
          <div className="h-48 bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
            {athlete.name.charAt(0)} {/* Forbokstav som placeholder bilde */}
          </div>
